...
int CropClip::prepare_actions()
{
	...
	leftClip->set_right_edge(TTimeRef(x1 * m_cv->get_sheetview()->timeref_scalefactor) + m_clip->get_location_item()->get_location_start());
	...
	rightClip->set_left_edge(TTimeRef(x2 * m_cv->get_sheetview()->timeref_scalefactor) + m_clip->get_location_item()->get_location_start());
    rightClip->get_location_item()->set_location_start(leftClip->get_location_item()->get_location_end());
