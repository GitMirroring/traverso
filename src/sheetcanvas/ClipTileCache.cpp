...
ClipTile* ClipTileCache::find(TAudioClip* clip, TileHash hash)
{
...
ClipTile& ClipTileCache::insert(TAudioClip* clip, TileHash hash, quint64 start, const QSize& size)
{
...
void ClipTileCache::invalidate_clip(TAudioClip* clip)
{
...
void ClipTileCache::invalidate_clip_range(TAudioClip* clip, int zoom, qreal start, qreal end)
{
