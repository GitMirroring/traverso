...
public:
    TFadeCurveView(TSheetView* sv, TAudioClipView* parent, TFadeCurve* fadeCurve);
    ~TFadeCurveView();
	...
	TFadeCurve* get_fade() const {return m_fadeCurve;}
    TAudioClip* get_audio_clip() const {return m_audioClip;}
	
	void load_theme_data();

private:
	TFadeCurve*	m_fadeCurve;
    TAudioClip*  m_audioClip;
	TCurve*		m_guicurve;
	bool		m_holdactive;
